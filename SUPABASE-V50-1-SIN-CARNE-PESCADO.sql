-- =============================================================
-- DAVID & RAQUEL · V50.1
-- Eliminar obligación Carne/Pescado
...
begin
  ...
  if adultos_num > adultos_permitidos then
    raise exception 'Esta invitación permite un máximo de % adultos',
      adultos_permitidos;
  end if;

  if ninos_num > ninos_permitidos then
    raise exception 'Esta invitación permite un máximo de % niños',
      ninos_permitidos;
  end if;
